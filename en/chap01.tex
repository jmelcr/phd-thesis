...
being accessible for both experimental and simulation studies. 
...
Another view, emerging more recently, suggests much stronger interactions between phospholipids and monovalent cations. 
...
which accounts for electronic polarization through electronic continuum correction (see section~\ref{section:ecc}), 
...
to demonstrate the robustness of the electrometer concept and its negligible chemical specificity~\citep{seelig87, beschiasvili91}. 
