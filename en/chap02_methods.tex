...
\todo{Dissect the following text from \citep{huang2017mapping}, which summarizes main problems in polarizable simulations and their recent devel.}
A variety of polarizable FFs have been developed using different formalisms to model polarizability.  8–19 
...
Two of the most widely used polarizable FFs are the AMOEBA FF18,20–23 and the Drude FF.19,24–33 
...
Amoeba references: \citep{amoeba06, amoeba10, amoeba13}
...
The theory for accounting for electronic polarization implicitly in a mean field way in empirical force fields
