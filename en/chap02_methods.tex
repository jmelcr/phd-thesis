...
\todo{Rewrite the beginning, three bio in the first sentence, doesn't say really much.}
...
% Pavel: the commented line is not true
...
\todo{Reformulate the following so that it is not specific for Amber. Pavel finds the formula not that specific for Amber to mention it as an example.}
