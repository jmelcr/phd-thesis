...
Results from a large array of MD simulations of neutral and negatively charged membranes with \ce{NaCl} and \ce{CaCl2} 
...
In summary, all models examined in \citep{catte16} overestimate the response of head group order parameters and/or binding affinity of \ce{CaCl2} to POPC bilayers. 
...
in the mixed bilayer to increasing concentrations of \ce{CaCl2} 
...
After reproducing the concept of the lipid electrometer with a known amount of bound surface charge,
