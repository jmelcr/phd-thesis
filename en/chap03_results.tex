...
which account for electrionic polarization via ECC (introduced in sections~\ref{section:ecc} and \label{section:ecc-lipids}). 
It was demonstrated that such models, termed ECC-lipids, 
meet current accuracy standards in the field by a comparison with NMR order parameters and X-ray diffraction data. 
This chapter presents the application of such derived lipids models 
on the study of interactions between phospholipid bilayers and ions,
in which ECC-lipids excel any state-of-the-art lipid model. 
...
We put extra stress on the interactions with \ce{Ca^{2+}}, an important signalling cation, 
...
\todo{May be merged with the above section.}
...
is measured for mixtures of POPC with monovalent cationic surfactants (dihexadecyldimethylammonium) \citep{scherer89}. 
The amount of bound charge per PC 
in these systems is simply given by the molar fraction of the cationic surfactants, 
