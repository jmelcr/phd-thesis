...
we show simulation results from ECC-lipids and Lipid17 \citep{lipid17-future}
highlighting the improvement over Lipid17 arising from electronic polarization. 
...
Although the total magnitude of the response of the order parameteres in POPC 
...
\begin{figure}[tb!]
  ...
  \caption{\label{fig:hist_residence_times}
   ...
   and in a negatively charged membrane with a compostion 5\,PC:1\,PS (blue)
