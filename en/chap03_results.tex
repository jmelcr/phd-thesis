...
Interactions of \ce{Na^+} cations with neutral POPC bilayers were studied in \citep{catte16}, 
and with negatively charged mixed 5\,PC:1\,PS bilayers in \citep{nmrlipids_proj4}. 
...
In line with our works \citep{catte16, nmrlipids_proj4}, the results suggest that improvements 
...
which is plotted for \ce{NaCl} in Figs.~\ref{fig:delta_ordPar_NaCl} and \ref{fig:delta_ordPar_NaCl_PCPS}, 
