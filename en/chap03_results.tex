...
\begin{figure}[htb!] 
  ...
  \caption{\label{fig:delta_ordPar_NaCl} 
    Changes of the head group order parameters of a POPC bilayer as a function of \ce{NaCl} and \ce{KCl} concentration 
...
\begin{figure}[tbp!] 
  ...
  \caption{\label{fig:delta_ordPar_NaCl} 
    ...
    The experimental data for POPC show with a dashed line the response of the order parameters to \ce{LiCl} 
